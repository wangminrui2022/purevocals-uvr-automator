...
# 基础用法
# python scripts\purevocals.py "F:\命理学-音频" "F:\命理学-音频-干声"
# 指定高质量模型
# python scripts\purevocals.py "F:\命理学-音频\猴哥说易\月支月令如何看一个人事业！.mp3" "F:\命理学-音频-干声" --model "6_HP-Karaoke-UVR.pth"
# 仅处理前30秒预览
# python scripts\purevocals.py "F:\命理学-音频" "F:\命理学-音频-干声" --sample_mode
# 批量 + 最快模型
# python scripts\purevocals.py "F:\命理学-音频" "F:\命理学-音频-干声" --model "UVR_MDXNET_KARA_2.onnx"
